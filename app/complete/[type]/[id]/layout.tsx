...
export default async function Layout({ children }: Params) {
    ...
    return (
        <div className="flex flex-col gap-8 px-4 py-6 h-full justify-center">
            {children}
            <svg viewBox="0 0 200 200" className=" fill-fuchsia-400/30 absolute top-[75vh] scale-[300%] blur-3xl opacity-50 dark:opacity-50 -z-10" xmlns="http://www.w3.org/2000/svg">
